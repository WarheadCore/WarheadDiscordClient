...
// Add option
template<typename T>
WH_CLIENT_API void DiscordConfig::AddOption(std::string_view optionName, Optional<T> def /*= std::nullopt*/)
{
...
// Get option
template<typename T>
WH_CLIENT_API T DiscordConfig::GetOption(std::string_view optionName, Optional<T> def /*= std::nullopt*/)
{
    // copy from string_view
    std::string option{ optionName };
...
// Set option
template<typename T>
WH_CLIENT_API void DiscordConfig::SetOption(std::string_view optionName, T value)
{
    // copy from string_view
    std::string option{ optionName };
...
#define TEMPLATE_GAME_CONFIG_OPTION(__typename) \
    template WH_CLIENT_API __typename DiscordConfig::GetOption(std::string_view optionName, Optional<__typename> def /*= std::nullopt*/); \
    template WH_CLIENT_API void DiscordConfig::SetOption(std::string_view optionName, __typename value);
